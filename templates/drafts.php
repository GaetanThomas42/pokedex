            ...
            <div class="card mb-4">
                ...
                <div class="card-body d-flex justify-content-between align-items-center">
                    ...
                    <div class="text-center flex-grow-1 mx-3">
                        <h3><?= $draft->getPokemon()->getNameFr() ?> (<?= $draft->getPokemon()->getNameJp() ?>)</h3>
                        <p><strong>Génération:</strong> <?= $draft->getPokemon()->getGeneration() ?></p>
                        <p><strong>Catégorie:</strong> <?= $draft->getPokemon()->getCategory() ?></p>
                        <p><strong>Poids:</strong> <?= $draft->getPokemon()->getWeight() ?> kg</p>
                    </div>
